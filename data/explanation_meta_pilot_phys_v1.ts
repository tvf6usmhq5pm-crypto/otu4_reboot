...
export const explanationMetaPilotPhysV1: ExplanationMetaMap = {
  ...
  'PHYS-003-005': {
    ...
    tableHeader: ['指標', '危険な向き', '理由'],
    rows: [
      {
        cells: ['火炎伝播速度', '大きいほど危険', '炎が速く広がる'],
        variant: 'correct',
      },
      {
        cells: ['引火点', '低いほど危険', '低温でも引火しやすい'],
      },
      {
        cells: ['沸点', '低いほど危険', '蒸発しやすく、可燃性蒸気をつくりやすい'],
      },
      {
        cells: ['最小着火エネルギー', '小さいほど危険', 'わずかな火花でも着火しやすい'],
      },
      {
        cells: ['導電率', '小さいほど危険', '静電気が逃げにくく蓄積しやすい'],
      },
    ],
    optionMemos: {
