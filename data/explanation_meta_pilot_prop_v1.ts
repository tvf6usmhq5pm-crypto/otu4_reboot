...
export const explanationMetaPilotPropV1: ExplanationMetaMap = {
  'PROP-003-001': {
    ...
    tableHeader: ['消火方法', '主な作用', '判断'],
    rows: [
      {
        cells: ['泡消火剤', '油面を覆って空気を遮断', '適切'],
        variant: 'correct',
      },
      {
        cells: ['粉末消火剤', '燃焼の連鎖反応を抑える', '適切'],
        variant: 'correct',
      },
      {
        cells: ['二酸化炭素消火剤', '酸素濃度を下げる', '適切'],
        variant: 'correct',
      },
      {
    ...
    optionMemos: {
      0: '泡消火剤は油面を覆い、空気を遮断するため適切です。',
      1: '粉末消火剤は燃焼の連鎖反応を抑えるため適切です。',
      2: '二酸化炭素消火剤は酸素濃度を下げる窒息作用があり適切です。',
      4: '霧状の強化液は油面を強く叩きにくいため、棒状放射とは区別します。',
    },
  },
